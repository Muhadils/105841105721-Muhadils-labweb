...
class Home extends Component {
    render() {
        const mainImage = require('./assets/model/jabe.png');
        const newImages = [
            { source: require('./assets/model/pp.png'), title: 'distro', subtitle: '101$' },
            { source: require('./assets/model/pp1.png'), title: 'casual', subtitle: '122$' },
            { source: require('./assets/model/pp2.png'), title: 'planet surtf', subtitle: '135$' },
            { source: require('./assets/model/pp3.png'), title: 'dress', subtitle: '155$' },
