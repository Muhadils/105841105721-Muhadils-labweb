...
const katalog2 = () => {
  ...
  const [products, setProducts] = useState([
    {
      name: 'Casual T-shirt',
      image: require('./assets/model/pp.png'),
      color: 'Brown',
      size: 'M',
      originalPrice: 29, 
      price: 26,
    ...
    {
      name: 'Summer Blouse',
      image: require('./assets/model/pp1.png'),
      color: 'Pink',
      size: 'L',
      price: 49,
      rating: 5,
    ...
    {
      name: 'T-shirt',
      image: require('./assets/model/pp2.png'),
      color: 'Black',
      size: 'L',
      originalPrice: 90, 
      price: 81,
  ...
  const renderItem = ({ item, index }) => (
    <View style={styles.productItem}>
      ...
      <TouchableOpacity style={styles.loveButton} onPress={() => toggleLove(index)}>
        <Image
          source={item.loved ? require('./assets/icon/heart.png') : require('./assets/icon/heart1.png')}
