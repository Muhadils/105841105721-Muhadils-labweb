...
const katalog1 = () => {
  ...
  const [products, setProducts] = useState([
    {
      name: 'Casual T-shirt',
      image: require('./assets/model/pose.png'),
      color: 'brown',
      size: 'M',
      price: 25,
      rating: 4,
    ...
    {
      name: 'Summer Blouse',
      image: require('./assets/model/pose1.png'),
      color: 'warm',
      size: 'L',
      price: 52,
      rating: 5,
    ...
    {
      name: 'T-shirt',
      image: require('./assets/model/pose2.png'),
      color: 'whait',
      size: 'L',
      price: 80,
      rating: 5,
    ...
    {
      name: 'Party Dress',
      image: require('./assets/model/pp3.png'),
      color: 'pink',
      size: 'L',
      price: 21,
      rating: 3,
        ...
        renderItem={({ item, index }) => (
          <View style={styles.productContainer}>
            ...
            <TouchableOpacity style={styles.loveButton} onPress={() => toggleLove(index)}>
              <Image source={item.loved ? require('./assets/icon/heart.png') : require('./assets/icon/heart1.png')} style={styles.loveIcon} />
            </TouchableOpacity>
          </View>
        )}
