      ...
      <ScrollView>
        ...
        <View style={styles.categoriesContainer}>
          <TouchableOpacity style={styles.categoryItem}>
            ...
            <Image source={require('./assets/model/model.png')} style={styles.categoryImage} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.categoryItem}>
            <Text style={styles.categoryText}>Clothes</Text>
            <Image source={require('./assets/model/model1.png')} style={styles.categoryImage} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.categoryItem}>
            <Text style={styles.categoryText}>Shoes</Text>
            <Image source={require('./assets/model/model2.png')} style={styles.categoryImage} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.categoryItem}>
            <Text style={styles.categoryText}>Accessories</Text>
            <Image source={require('./assets/model/model3.png')} style={styles.categoryImage} />
          </TouchableOpacity>
        </View>
      </ScrollView>
    </View>
